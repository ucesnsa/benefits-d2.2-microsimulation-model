...
`dial_tool_italy.html` is Deliverable D2.2's tool for Italy, and it is the whole thing:
...
The page carries its own copy of the Italian response surface, embedded when the tool was built.
...
reference year, Italy's 2023 policy system). Neither the engine nor the microdata is in
...
* **The provider chains** — [`../../docs/VALUATION_CHAINS.md`](../../docs/VALUATION_CHAINS.md),
  ...
  all four countries, Italy included.
